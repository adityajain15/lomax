<template>
  <g>
    ...
    <template v-for="(personObject, person, personIndex) of peopleData">
      <Stigma :personObject="personObject" :person="person" :index="index" :personIndex="personIndex" :angleSize="angleSize" :halfWidth="halfWidth" :numPeople="numPeople" :angleShift="angleShift" :petalCords="petalCords" :county="county" :personRecord="getPersonAttributes(person)">
      </Stigma>
    </template>
